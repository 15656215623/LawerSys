...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">律师工作平台- ${self }用户</h3>
	</div>
	<div class="panel-body">
	   ...
	   <input type="text" value=${l.self }   id="lawername"/>
...
messageItem = '<li>'
		        ...
		        +'<img src="'+logo+'" class="userlogo"/></div></div></li>'   
      }else{
          //直接显示
messageItem ='<li><div class="row" ><div class="col-md-4">' 
		        +message.date+'</div></div>'	
		        +'<div class="row" ><div class="col-md-2">'	 
		        +'<img src="logo/mr.png"   class="userlogo"/>'
   	...
   	socket.close();
   	//返回律师中心
   	window.location.href="http://localhost:8080/LawerSys/layer.jsp";
   	});
